...
if(render_part==2) {
  ...
  %  translate([0,0,drive_bearing_th+1.0]) 
//  motor_drive_gear(
...
//  );
    drive_gears(gear_num_teeth=17,gear_spacing=0.0, roller_axle_d=roller_axle_d, motor_axle_d=motor_axle_d,annotate=false);

  roller_retainer_ring(gear_d=gear_d);
}


module roller_alignment_gear(
	gear_d=gear_d, gear_num_teeth=gear_num_teeth
	, gear_thickness=drive_gear_thickness
	, gear_clearance=gear_clearance
	, bevel_dr=bevel_dr, axle_d=roller_axle_d
...
module alignment_gears(
	gear_d=gear_d, gear_num_teeth=gear_num_teeth, gear_spacing=1.0
	, alignment_gear_thickness=alignment_gear_thickness
	, roller_axle_d=roller_axle_d, motor_axle_d=motor_axle_d
	, roller_gear_count=roller_count
	, gear_clearance=0.4
	, bevel_dr=bevel_dr
  ...
  if(annotate) {
    ...
    echo(str("  gear_num_teeth=",gear_num_teeth));
    echo(str("  gear_spacing=",gear_spacing));
    echo(str("  alignment_gear_thickness=",alignment_gear_thickness));
    echo(str("  roller_axle_d=",roller_axle_d));
    echo(str("  motor_axle_d=",motor_axle_d));
    echo(str("  roller_gear_count=",roller_gear_count));
    echo(str("  gear_clearance=",gear_clearance));
  ...
  op_position_rollers_driver(gear_d=gear_d, gear_num_teeth=gear_num_teeth, gear_spacing=gear_spacing
    ...
    roller_alignment_gear(
      gear_d=gear_d, gear_num_teeth=gear_num_teeth, gear_thickness=alignment_gear_thickness, gear_spacing=gear_spacing, twist_ratio=twist_ratio
      , axle_d=roller_axle_d, gear_clearance=gear_clearance, bevel_dr=bevel_dr, coupler_thickness=coupler_thickness, annotate=false
    );
    motor_alignment_gear(
      gear_d=gear_d, gear_num_teeth=gear_num_teeth, gear_thickness=alignment_gear_thickness, gear_spacing=gear_spacing, twist_ratio=twist_ratio
      , axle_d=motor_axle_d, gear_clearance=gear_clearance, bevel_dr=bevel_dr, coupler_thickness=coupler_thickness, annotate=false
    );
  }
...
if(render_part==3) {
  ...
  alignment_gears(gear_num_teeth=17,gear_spacing=2.0, roller_axle_d=roller_axle_d, motor_axle_d=motor_axle_d,annotate=true);
}
