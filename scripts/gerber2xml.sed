...
s/X\([0-9][0-9]*\)Y\([0-9][0-9]*\)D01/<d01_draw><x>\1<\/x><y>\2<\/y><\/d01_draw>/g
s/X\([0-9][0-9]*\)Y\([0-9][0-9]*\)D02/<d02_move><x>\1<\/x><y>\2<\/y><\/d02_move>/g
s/X\([0-9][0-9]*\)Y\([0-9][0-9]*\)D03/<d03_flash><x>\1<\/x><y>\2<\/y><\/d03_flash>/g
s/X\([0-9]*\)/<x>\1<\/x>/g
s/Y\([0-9]*\)/<y>\1<\/y>/g
s/M02$/<\/gcode>/g
